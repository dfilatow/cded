...
#' data \code{https://catalogue.data.gov.bc.ca/dataset/7b4fef7e-7cae-4379-97b8-62b03e9ac83d} for each of the NTS 50K Grid  Digital Baseline Mapping at 1:50,000 (NTS) polygons 
...
#'  @export
cded_fn<-function(aoi,cdedurl="https://pub.data.gov.bc.ca/datasets/175624/",resolution=NULL) 
{
